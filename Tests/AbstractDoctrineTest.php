...
abstract class AbstractDoctrineTest extends TestCase
{
	...
	public function getBasicFixtures(): array
	{
		return [
			...
			['Title2', 1, \DateTime::createFromFormat('H:i:s', "15:33:00"), new \DateTime('2017-01-23 12:15:00')],
			['Title3', 1, \DateTime::createFromFormat('H:i:s', "17:33:00"), new \DateTime('2017-01-24 13:14:00')],
